...
abstract class PBKDF2Core extends SecretKeyFactorySpi {
    ...
    {
        PBENullSaltKeySpec ks;
        if (keySpec instanceof PBEKeySpec) {
            ks = new PBENullSaltKeySpec((PBEKeySpec) keySpec);
            return new PBKDF2KeyImpl(ks, prfAlgo);
        } else if (keySpec instanceof PBENullSaltKeySpec) {
            ks = (PBENullSaltKeySpec) keySpec;
            return new PBKDF2KeyImpl(ks, prfAlgo);
        } else {
        ...
        if (key instanceof javax.crypto.interfaces.PBEKey) {
            ...
            if ((keySpecCl != null)
                && (PBEKeySpec.class.isAssignableFrom(keySpecCl))
                    || PBENullSaltKeySpec.class.isAssignableFrom(keySpecCl)) {
                javax.crypto.interfaces.PBEKey pKey =
                    (javax.crypto.interfaces.PBEKey) key;
                return new PBENullSaltKeySpec
        ...
        if ((key != null) &&
            ...
            if (key instanceof javax.crypto.interfaces.PBEKey) {
                javax.crypto.interfaces.PBEKey pKey =
                    (javax.crypto.interfaces.PBEKey) key;
                try {
                    PBENullSaltKeySpec spec =
                        new PBENullSaltKeySpec(pKey.getPassword(),
                                               pKey.getSalt(),
